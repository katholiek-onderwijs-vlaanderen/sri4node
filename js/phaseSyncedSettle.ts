...
export = module.exports = async (jobList, { maxNrConcurrentJobs = 1, beforePhaseHooks = [] } = {}) => {
    ...
    try {
        ...
        ctrlEmitter.on('stepDone', errorHandlingWrapper(async function (id, stepnr) {
        ...
        ctrlEmitter.on('jobDone', errorHandlingWrapper(async function (id) {
        ...
        ctrlEmitter.on('jobFailed', errorHandlingWrapper(async function (id) {
