...
export type TSriQueryFun = {
    defaultFilter?: (valueEnc: string, query: TPreparedSql, parameter: any, mapping: TResourceDefinition, database: pgPromise.IDatabase<unknown, IClient>) => void;
} | {
    [key: string]: (value: string, select: TPreparedSql, key: string, database: pgPromise.IDatabase<unknown, IClient>, count: number, mapping: TResourceDefinition) => void;
};
