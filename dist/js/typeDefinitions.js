...
exports.isStreamingCustomRouteDefinition = exports.isNonStreamingCustomRouteDefinition = exports.isLikeCustomRouteDefinition = exports.SriError = void 0;
class SriError {
    /**
...
exports.SriError = SriError;
function isLikeCustomRouteDefinition(cr) {
    return "like" in cr;
}
exports.isLikeCustomRouteDefinition = isLikeCustomRouteDefinition;
function isNonStreamingCustomRouteDefinition(cr) {
    return "handler" in cr;
}
exports.isNonStreamingCustomRouteDefinition = isNonStreamingCustomRouteDefinition;
function isStreamingCustomRouteDefinition(cr) {
    return "streamingHandler" in cr;
}
exports.isStreamingCustomRouteDefinition = isStreamingCustomRouteDefinition;
// const sriConfig = {
//   "plugins": [
//     {
