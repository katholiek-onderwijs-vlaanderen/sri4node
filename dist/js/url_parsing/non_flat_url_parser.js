...
exports.generateNonFlatQueryStringParser = exports.generateNonFlatQueryStringParserGrammar = void 0;
...
function parseTreeSortFunction(a, b) {
    return [
        ...
        [() => a.operator && b.operator && a.operator.name < b.operator.name, -1],
    ].reduce((acc, [test, response]) => (acc !== null || !test() ? acc : response), 0);
}
/**
...
function normalizeRowFilter(rowFilter) {
    const retVal = Object.assign({}, rowFilter);
    if (rowFilter.operator.name === "EQ") {
        // translate EQ to IN
        retVal.operator = Object.assign(Object.assign({}, rowFilter.operator), { name: "IN", multiValued: true });
        ...
        if (invertedOperatorName) {
            retVal.operator = Object.assign(Object.assign({}, rowFilter.operator), { name: invertedOperatorName });
...
function normalizeColumnFilter(columnFilter) {
    const retVal = Object.assign({}, columnFilter);
...
function produceValue(property = {}, operator = {}, escapedUnparsedValue) {
    ...
    return translateValueType(safeProperty, safeOperator, Array.isArray(parsedValue) ? value : parsedValue);
}
/**
...
function parsedQueryStringToParseTreeWithDefaults(flatParseTree, defaultParseTree = {}) {
    ...
    const retVal = Object.assign({}, defaultParseTree);
    ...
    Object.entries(typeToSubTreeNameMap).forEach(([type, subTreeName]) => {
        const flatParseTreeOfCurrentType = Object.values(flatParseTree)
            ...
            .map((item) => {
            const _a = item, { type: _itemType } = _a, restOfTheItem = __rest(_a, ["type"]);
            return restOfTheItem;
        });
        retVal[subTreeName] = mergeArrays(flatParseTreeOfCurrentType, defaultParseTree[subTreeName], (a, b) => a.property === b.property && a.operator.name === b.operator.name);
    });
    return retVal;
}
/**
 ...
 */
function generateNonFlatQueryStringParserGrammar(flattenedJsonSchema, sriConfigDefaults, sriConfigResourceDefinition) {
    ...
    const defaultParseTree = {
        ...
        listControl: [
            ...
            // { metaProperty: 'LIST_PROPERTYNAME', operator: 'IN', value: value: ['$$meta.created', '$$meta.modified', 'results[*].href', 'results[*].$$expanded'] }, // not count
            {
                ...
                value: (sriConfigDefaults === null || sriConfigDefaults === void 0 ? void 0 : sriConfigDefaults.defaultlimit) ||
                    ((sriConfigResourceDefinition === null || sriConfigResourceDefinition === void 0 ? void 0 : sriConfigResourceDefinition.maxlimit)
...
exports.generateNonFlatQueryStringParserGrammar = generateNonFlatQueryStringParserGrammar;
function generateNonFlatQueryStringParser(sriConfigDefaults, sriConfigResourceDefinition, allowedStartRules = undefined) {
    const grammar = generateNonFlatQueryStringParserGrammar((0, schemaUtils_1.flattenJsonSchema)((sriConfigResourceDefinition === null || sriConfigResourceDefinition === void 0 ? void 0 : sriConfigResourceDefinition.schema) || {}), sriConfigDefaults, sriConfigResourceDefinition);
    const options = {
        parseTreeSortFunction,
        normalizeRowFilter,
        normalizeColumnFilter,
    ...
    const pegConf = allowedStartRules
        ...
        : {};
    const parser = peggy_1.default.generate(grammar, pegConf);
    ...
    // );
    return Object.assign(Object.assign({}, parser), { origParse: parser.parse, parse: (input, moreOptions = {}) => parser.parse(input, Object.assign(Object.assign({}, moreOptions), options)) });
}
exports.generateNonFlatQueryStringParser = generateNonFlatQueryStringParser;
//# sourceMappingURL=non_flat_url_parser.js.map