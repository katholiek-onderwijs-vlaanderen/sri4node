...
exports.generateFlatQueryStringParserGrammar = void 0;
/**
...
function generateFlatQueryStringParserGrammar(flattenedJsonSchema) {
    ...
    const propertyNameToOtherThanStringTypeMap = Object.assign(Object.assign({}, Object.fromEntries(Object.entries(flattenedJsonSchema)
        .filter(([_k, v]) => !v.enum && v.type !== "string")
        .map(([k, v]) => [k, v.type]))), { "$$meta.deleted": "boolean", "$$meta.version": "integer" });
...
exports.generateFlatQueryStringParserGrammar = generateFlatQueryStringParserGrammar;
//# sourceMappingURL=flat_url_parser.js.map