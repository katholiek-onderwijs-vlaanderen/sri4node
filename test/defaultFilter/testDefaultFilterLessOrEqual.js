  ...
  describe('Generic Filters', function () {
    ...
    describe('LessOrEqual (alias Before) match', function () {
      ...
      describe('String fields', function () {
        ...
        // text
        it('should find resources of type text that are lower', async function () {
        ...
        it('should find resources of type text that are lower with operator Before (alias)', async function () {
        ...
        // varchar
        it('should find resources of type varchar that are lower', async function () {
        ...
        it('should find resources of type varchar that are lower with operator Before (alias)', async function () {
        ...
        // char
        it('should find resources of type char that are lower', async function () {
        ...
        it('should find resources of type char that are lower with operator Before (alias)', async function () {
      ...
      describe('Numeric fields', function () {
        ...
        // numeric
        it('should find resources of type numeric that are lower', async function () {
        ...
        it('should find resources of type numeric that are lower with operator Before (alias)', async function () {
        ...
        // integer
        it('should find resources of type integer that are lower', async function () {
        ...
        it('should find resources of type integer that are lower with operator Before (alias)', async function () {
        ...
        // bigint
        it('should find resources of type bigint that are lower', async function () {
        ...
        it('should find resources of type bigint that are lower with operator Before (alias)', async function () {
        ...
        // smallint
        it('should find resources of type smallint that are lower', async function () {
        ...
        it('should find resources of type smallint that are lower with operator Before (alias)', async function () {
        ...
        // decimal
        it('should find resources of type decimal that are lower', async function () {
        ...
        it('should find resources of type decimal that are lower with operator Before (alias)', async function () {
        ...
        // real
        it('should find resources of type real that are lower', async function () {
        ...
        it('should find resources of type real that are lower with operator Before (alias)', async function () {
        ...
        // double precision
        it('should find resources of type double precision that are lower', async function () {
        ...
        it('should find resources of type double precision that are lower with operator Before (alias)', async function () {
        ...
        // smallserial
        it('should find resources of type smallserial that are lower', async function () {
        ...
        it('should find resources of type smallserial that are lower with operator Before (alias)', async function () {
        ...
        // serial
        it('should find resources of type serial that are lower', async function () {
        ...
        it('should find resources of type serial that are lower with operator Before (alias)', async function () {
        ...
        // bigserial
        it('should find resources of type bigserial that are lower', async function () {
        ...
        it('should find resources of type bigserial that are lower with operator Before (alias)', async function () {
      ...
      describe('Timestamp fields', function () {
        it('should find resources that are lower', async function () {
        ...
        it('should find resources that are lower with operator Before (alias)', async function () {
