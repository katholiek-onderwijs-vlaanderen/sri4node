    ...
    describe('RegEx match', () => {
      describe('String fields', () => {
        ...
        it('should find resources of type text with a regex', async () => {
          const response = await httpClient.get({ path: '/alldatatypes?textRegEx=%5E(.*)%5Bv%7CV%5Dalue(.*)%24', auth: 'kevin' });
        ...
        it('should find only one resource of type text with a regex', async () => {
          const response = await httpClient.get({ path: '/alldatatypes?textRegEx=%5E(.%20)%5Bv%7CV%5Dalue(.*)%24', auth: 'kevin' });
          assert.equal(response.status, 200);
        ...
        it('should not find resources of type text with a regex', async () => {
          const response = await httpClient.get({ path: '/alldatatypes?textRegEx=%5E%5B0-9%5D*%24', auth: 'kevin' });
          assert.equal(response.status, 200);
        ...
        it('should find resources of type varchar with a regex', async () => {
          const response = await httpClient.get({ path: '/alldatatypes?textvarcharRegEx=%5E(.*)%5Bv%7CV%5Darc(.*)%24', auth: 'kevin' });
          assert.equal(response.status, 200);
          assert.equal(response.body.results.length, 2);
        ...
        it('should find only one resource of type varchar with a regex', async () => {
          const response = await httpClient.get({ path: '/alldatatypes?textvarcharRegEx=%5E(.*)%5Bt%7CT%5Dext(.*)%24', auth: 'kevin' });
          assert.equal(response.status, 200);
          assert.equal(response.body.results.length, 1);
        ...
        it('should not find resources of type varchar with a regex', async () => {
          const response = await httpClient.get({ path: '/alldatatypes?textvarcharRegEx=%5E%5B0-9%5D*%24', auth: 'kevin' });
          assert.equal(response.status, 200);
          assert.equal(response.body.results.length, 0);
        });
        ...
        it('should find resources of type char with a regex', async () => {
          const response = await httpClient.get({ path: '/alldatatypes?textcharRegEx=%5E(.*)%5Bc%7CC%5Dha(.*)%24', auth: 'kevin' });
          assert.equal(response.status, 200);
          assert.equal(response.body.results.length, 2);
        ...
        it('should find only one resource of type char with a regex', async () => {
          const response = await httpClient.get({ path: '/alldatatypes?textcharRegEx=%5E(.*)%5Bt%7CT%5Dext(.*)%24', auth: 'kevin' });
          assert.equal(response.status, 200);
          assert.equal(response.body.results.length, 1);
        ...
        it('should not find resources of type char with a regex', async () => {
          const response = await httpClient.get({ path: '/alldatatypes?textcharRegEx=%5E%5B0-9%5D*%24', auth: 'kevin' });
          assert.equal(response.status, 200);
          assert.equal(response.body.results.length, 0);
        });
