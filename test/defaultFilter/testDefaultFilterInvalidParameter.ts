  ...
  describe('Generic Filters', () => {
    describe('Invalid parameter (non existent)', () => {
      it('should return 404 - not found', async () => {
        const response = await httpClient.get({ path: '/alldatatypes?wrongParameter=multiple', auth: 'kevin' });
      ...
      it('should return the list of possible parameters', async () => {
        ...
        assert.deepEqual(_.orderBy(response.body.errors[0].possibleParameters),
